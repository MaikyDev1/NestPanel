...
export function InputTypeBox({id, title, name, placeholder, defaultText, error}) {
  return (
    <div className="w-full">
      ...
      <input name={name} className={(error ? "ring-2 ring-rose-600 text-rose-600 " : "focus:ring-2 focus:ring-amber-400 mb-2") + " appearance-none outline-none bg-neutral-100 w-full rounded py-2 px-3"}
